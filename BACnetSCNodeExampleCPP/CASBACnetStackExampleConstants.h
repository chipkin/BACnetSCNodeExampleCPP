...
public:
	...
	static const uint8_t CAS_NETWORK_TYPE_SC = 2;
	...
	// Reliability
	static const uint8_t RELIABILITY_NO_FAULT_DETECTED = 0;
	static const uint8_t RELIABILITY_UNRELIABLE_OTHER = 7;

	// Debug Message Type
	static const uint8_t BACNET_DEBUG_LOG_TYPE_ERROR = 0;
	static const uint8_t BACNET_DEBUG_LOG_TYPE_INFO = 1;

	// Character String Encoding Types
